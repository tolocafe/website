/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3a421328a41ff4082cdbb102535062e0)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<
			Cloudflare.Env,
			'VALUE_FROM_CLOUDFLARE' | 'VITE_PUBLIC_POSTHOG_KEY' | 'VITE_PUBLIC_POSTHOG_HOST'
		>
	> {}
}
