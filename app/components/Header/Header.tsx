...
export function Header() {
	...
	const currentLocale: Locale = isValidLocale(localeParam) ? localeParam : DEFAULT_LOCALE
	...
	function isActive(item: (typeof navItems)[number]) {
		...
		if ('matchHash' in item && item.matchHash && location.hash !== item.matchHash) return false
		return true
	}
