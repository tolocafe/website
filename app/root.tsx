...
import { DEFAULT_LOCALE, isValidLocale, SUPPORTED_LOCALES, type Locale } from '~/lib/locale'
...
export function Layout({ children }: { children: React.ReactNode }) {
	...
	const localeMatch = matches.find((match) => (match.params as { locale?: string }).locale)
