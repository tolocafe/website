...
import { client, urlFor, getLocalizedString, getLocalizedSlug, type Bean } from '~/lib/sanity'
import * as styles from './beans.css'

const TRANSLATIONS = {
	es: {
		title: 'Nuestros Granos - TOLO',
		description: 'Descubre nuestros granos de café cuidadosamente seleccionados de todo el mundo',
	...
	en: {
		...
		description: 'Discover our carefully selected coffee beans from around the world',
		heading: 'Our Beans',
	...
	de: {
		...
		description: 'Entdecken Sie unsere sorgfältig ausgewählten Kaffeebohnen aus aller Welt',
	...
	fr: {
		...
		description: 'Découvrez nos grains de café soigneusement sélectionnés du monde entier',
		heading: 'Nos Grains',
								...
								return (
									...
									>
										...
										<div className={styles.beanContent}>
											...
											{excerpt && <p className={styles.beanExcerpt}>{excerpt}</p>}
