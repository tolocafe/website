	...
	es: {
		...
		topics: [
			...
			},
			{
				...
				description: 'Historias sobre las fincas y regiones de donde provienen nuestros granos.',
			},
			{
				title: 'Novedades de la Tienda',
				description: 'Noticias sobre nuevas ofertas, eventos y lo que pasa en TOLO.',
			},
		],
	},
	en: {
		...
		topics: [
			...
			},
			{
				...
				description: 'Stories about the farms and regions where our beans come from.',
			},
			{
				title: 'Shop Updates',
				description: "News about new offerings, events, and what's happening at TOLO.",
			},
		],
	},
	de: {
		...
		topics: [
			...
			},
			{
				...
				description: 'Geschichten über die Farmen und Regionen, aus denen unsere Bohnen stammen.',
			},
			{
				title: 'Shop-Neuigkeiten',
				description: 'Neuigkeiten über neue Angebote, Veranstaltungen und was bei TOLO passiert.',
			},
		],
	},
	fr: {
		...
		topics: [
			...
			},
			{
				...
				description: "Histoires sur les fermes et les régions d'où proviennent nos grains.",
			},
			{
				title: 'Actualités de la Boutique',
				description: 'Nouvelles sur les nouvelles offres, événements et ce qui se passe chez TOLO.',
			},
		],
	},
	ja: {
		...
		topics: [
			...
			{
				title: 'ショップニュース',
				description: '新商品、イベント、TOLOで起きていることについてのニュース。',
			},
		],
	},
} as const
					...
					{posts.length > 0 ? (
						<div className={styles.postsList}>
							{posts.map((post) => {
								...
								return (
									<Link key={post._id} to={`/${locale}/blog/${slug}`} className={styles.postCard}>
										{imageUrl && (
